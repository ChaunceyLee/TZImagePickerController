...
- (void)pushTZImagePickerController {
    ...
    TZImagePickerController *imagePickerVc = [[TZImagePickerController alloc] initWithMaxImagesCount:self.maxCountTF.text.integerValue columnNumber:self.columnNumberTF.text.integerValue delegate:self showAlbumInPhotoPickerVc:YES];
